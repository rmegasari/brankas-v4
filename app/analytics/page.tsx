...
export default function AnalyticsPage() {
  ...
  const { totalIncome, totalExpense, totalSavings, savingsRate, finalBalance } = useMemo(() => {
    ...
    const initialBalance = platformBalances.reduce((sum, platform) => sum + (platform.balance || 0), 0)
          ...
          <>
            <div className="mb-8 grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-5 max-w-6xl">
              <Card className="neobrutalism-card">
                ...
                <CardContent>
                  <div className="text-lg font-bold text-secondary break-words">
              ...
              <Card className="neobrutalism-card">
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                  <CardTitle className="text-sm font-semibold">Total Tabungan</CardTitle>
              ...
              <Card className="neobrutalism-card">
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                  <CardTitle className="text-sm font-semibold">Saldo Akhir</CardTitle>
                ...
                <CardContent>
                  ...
                  <div className="text-xs text-muted-foreground mt-1">{formatCurrency(finalBalance)}</div>
                </CardContent>
              </Card>
              <Card className="neobrutalism-card">
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                  <CardTitle className="text-sm font-semibold">Tingkat Tabungan</CardTitle>
            ...
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
              ...
              {chartType === "trends" && (
                <>
                  ...
                  <Card className="neobrutalism-card">
                    <CardHeader>
                      <CardTitle className="text-xl font-bold font-manrope">Tren Pemasukan Bulanan</CardTitle>
                    </CardHeader>
                    <CardContent>
                      <ResponsiveContainer width="100%" height={300}>
                        <LineChart data={monthlyData}>
                ...
                <Card className="neobrutalism-card col-span-1 lg:col-span-2">
                  ...
                  <CardContent>
                    <div className="text-center py-20 text-muted-foreground">
                      Fitur forecasting dan prediksi sedang dalam pengembangan.
                    </div>
                  </CardContent>
                </Card>
              )}
